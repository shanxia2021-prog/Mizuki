...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "1243102", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "698129945", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "玉子さんのカフェ", // 主页横幅主标题

			subtitle: [
				"冷たくない君の手のひらが見えた 淡い朝焼けの夜空",
				"もう二度と君を見つけられない 最後に残ったのは僕だった",
				"カラスの鳴く 鳥居の下 君が笑う 夏の隅で",
				"響く夜空に溶ける 透明哀歌",
				"咲いて snow white 今日も笑って泣いてもう、もう一回僕らの長い人生に気取ってキスしたら",
			],
			typewriter: {
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/Chiyuki_cat.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "白咲玉子",
	bio: "白い雪が花のように、静かに夜空で咲く",
	typewriter: {
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/698129945",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/shanxia2021-prog",
		},
		{
			name: "Discord",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Tamako's cafe!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
